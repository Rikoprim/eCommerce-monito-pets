...
const Detail = () => {
  ...
  useEffect(() => {
    const filteredDogs = productLook.find((dogs) => dogs._id === parseInt(id));
    ...
    <main>
      <Container>
        <div className="detail-body">
          <div className="detail-bodyColumn">
            <div className="slider">
              <div className="slider-rootImage">
                <Image
                  className="slider-rootImage"
                  src={`/img/catalog/dogs/${dogs.images}`}
                  width="100%"
                  alt="image-slide"
                ></Image>
              </div>
          ...
          <div className="detail-bodyColumn">
            ...
            <p className="subtitle">SKU #{dogs.SKU}</p>
            <h3 className="detail-title">{dogs.title}</h3>
            <p className="detail-price">
              {dogs.price.toLocaleString("ua-UA", {
                style: "currency",
                currency: "EUR",
              })}
            </p>
            ...
            <div className="info">
              <div className="infoRow">
                <span className="infoItem">SKU</span>
                <span className="infoItem">: {dogs.SKU}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Gender</span>
                <span className="infoItem">: {dogs.gene}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Age</span>
                <span className="infoItem">: {dogs.age}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Size</span>
                <span className="infoItem">: {dogs.size}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Color</span>
                <span className="infoItem">: {dogs.color}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Vaccinated</span>
                <span className="infoItem">: {dogs.vaccinated}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Dewormed</span>
                <span className="infoItem">: {dogs.dewormed}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Cert</span>
                <span className="infoItem">: {dogs.cert}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Microchip</span>
                <span className="infoItem">: {dogs.microchip}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Location</span>
                <span className="infoItem">: {dogs.location}</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Published Date</span>
                <span className="infoItem">: {dogs.published}</span>
              </div>
            </div>
          </div>
        </div>
