        ...
        <div className="detail-body">
          <div className="detail-bodyColumn">
            <div className="slider">
              <div className="slider-rootImage">
                <Image className="slider-rootImage" src="img/catalog/dogs/MO502 - Poodle Tiny Yellow.png" width="100%" alt="image-slide"></Image>
              </div>
            </div>
            <Image
              className="guarantee"
          ...
          <div className="detail-bodyColumn">
            <div className="detail-path">
              ...
              <a href="">MO231 - Pomeranian White</a>
            </div>
            <p className="subtitle">SKU #10001</p>
            <h3 className="detail-title">MO231 - Pomeranian White</h3>
            <p className="detail-price">€790.50</p>
            ...
            <div className="info">
              <div className="infoRow">
                ...
                <span className="infoItem">: 10001</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Gender</span>
                <span className="infoItem">: Male</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Age</span>
                <span className="infoItem">: 02 months</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Size</span>
                <span className="infoItem">: small</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Color</span>
                <span className="infoItem">: white</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Vaccinated</span>
                <span className="infoItem">: Yes</span>
              </div>
              <div className="infoRow">
              ...
              <div className="infoRow">
                ...
                <span className="infoItem">: Yes (MKA)</span>
              </div>
              <div className="infoRow">
              ...
              <div className="infoRow">
                ...
                <span className="infoItem">: Vietnam</span>
              </div>
              <div className="infoRow">
                <span className="infoItem">Published Date</span>
                <span className="infoItem">: 12-Oct-2022</span>
              </div>
            </div>
          </div>
        </div>
